...
#define WITH_SERVO // Enables Lid opening Servo
...
static const uint8_t DEFAULT_SOAK_TEPM_B      = 150; 
static const uint8_t DEFAULT_SOAK_DURATION    = 200; 
static const uint8_t DEFAULT_PEAK_TEPM        = 250;
static const uint8_t DEFAULT_PEAK_DURATION    = 15;
static const float   DEFAULT_RAMP_UP_RATE       = 3.0; // degrees / second (keep it about 1/2 of maximum to prevent PID overshooting)
static const float   DEFAULT_RAMP_DOWN_RATE     = 1.2; // degrees / second
